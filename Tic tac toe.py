...
lblTitle = Label(Tops, font=('arial', 50, 'bold'), text=" Tic Tac Toe", bd=21, fg='dodgerblue', bg='mistyrose',
                 justify=CENTER)
...
def scorekeeper():
    ...
    if (button1["text"] == "X" and button2["text"] == "X" and button3["text"] == "X"):
        ...
        score = (n + 1)
        PlayerX.set(score)
        pa = "Congratulations " + Player1.get() + " you have Won the Game!!"
...
txtPlayerX = Button(RightFrame1, font=('arial', 26, 'bold'), bd=2, fg="black", bg="yellow", textvariable=PlayerX,
                    width=4,
...
txtPlayerO = Button(RightFrame1, font=('arial', 26, 'bold'), bd=2, fg="black", bg="yellow", textvariable=PlayerO,
                    width=4,
                    justify=LEFT).grid(row=1, column=2)

btnReset = Button(RightFrame2, text="Reset", font=('arial', 40, 'bold'), height=1, width=15, fg='white', bg='dodgerblue',
                  command=reset)
...
btnNewGame = Button(RightFrame2, text="New  Game", font=('arial', 40, 'bold'), height=1, width=15, fg='white',
                    bg='dodgerblue', command=Newgame)
btnNewGame.grid(row=2, column=0, padx=1, pady=11)

button1 = Button(LeftFrame, text=" ", font=('arial', 30, 'bold'), height=3, width=8, bg='white',
                 command=lambda: checker(button1))
button1.grid(row=1, column=0, sticky=S + N + E + W)

button2 = Button(LeftFrame, text=" ", font=('arial', 30, 'bold'), height=3, width=8, bg='white',
                 command=lambda: checker(button2))
button2.grid(row=1, column=1, sticky=S + N + E + W)

button3 = Button(LeftFrame, text=" ", font=('arial', 30, 'bold'), height=3, width=8, bg='white',
                 command=lambda: checker(button3))
button3.grid(row=1, column=2, sticky=S + N + E + W)

button4 = Button(LeftFrame, text=" ", font=('arial', 30, 'bold'), height=3, width=8, bg='white',
                 command=lambda: checker(button4))
button4.grid(row=2, column=0, sticky=S + N + E + W)

button5 = Button(LeftFrame, text=" ", font=('arial', 30, 'bold'), height=3, width=8, bg='white',
                 command=lambda: checker(button5))
button5.grid(row=2, column=1, sticky=S + N + E + W)

button6 = Button(LeftFrame, text=" ", font=('arial', 30, 'bold'), height=3, width=8, bg='white',
                 command=lambda: checker(button6))
button6.grid(row=2, column=2, sticky=S + N + E + W)

button7 = Button(LeftFrame, text=" ", font=('arial', 30, 'bold'), height=3, width=8, bg='white',
                 command=lambda: checker(button7))
button7.grid(row=3, column=0, sticky=S + N + E + W)

button8 = Button(LeftFrame, text=" ", font=('arial', 30, 'bold'), height=3, width=8, bg='white',
                 command=lambda: checker(button8))
button8.grid(row=3, column=1, sticky=S + N + E + W)

button9 = Button(LeftFrame, text=" ", font=('arial', 30, 'bold'), height=3, width=8, bg='white',
